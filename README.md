...
2. Clone the repository or download the repository as a zip file.
    ...
    ```sh
    git clone https://github.com/ZBT-Tools/nomad-oasis.git
    cd nomad-oasis
    ```
    ...
    ```sh
    curl-L -o nomad-oasis.zip "https://github.com/ZBT-Tools/nomad-oasis/archive/main.zip"
...
your `docker-compose.yaml` with `ghcr.io/zbt-tools/nomad-oasis:main` for the services
...
```sh
docker pull ghcr.io/zbt-tools/nomad-oasis/jupyter:main
```
...
By default, documentation is built using the [nomad-docs](https://github.com/ZBT-Tools/nomad-docs) repository. However, if you'd like to customize the documentation for your Oasis instance, you can easily do so.

1. First, [fork the nomad-docs repository](https://github.com/ZBT-Tools/nomad-docs/fork).
...
_I get an_ `Error response from daemon: Head "https://ghcr.io/v2/ZBT-Tools/nomad-oasis/manifests/main": unauthorized`
